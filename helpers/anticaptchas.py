...
class TwoCaptchaApi:
    ...
    async def create_task(self, url: str, sitekey: str, cookies: str | None = None,
        ...
        response = await self._client.post('https://api.2captcha.com/createTask', headers=self.__headers,
                                           json=json_data)
        return response
    ...
    async def get_task_result(self, task_id: str | int) -> httpx.Response:
        ...
        response = await self._client.post('https://api.2captcha.com/getTaskResult', headers=self.__headers,
                                           json=json_data)
        return response
